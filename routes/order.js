...
orderRouter.get("/get-all-orders", authMiddleware, OrderController.getAllOrders);
...
orderRouter.get("/get-order-info-by-order/:order_id/:user_id", authMiddleware, OrderController.getOrderInfoByOrder)
...
orderRouter.get("/get-revenue-by-month", authMiddleware, OrderController.getRevenueByMonth);
orderRouter.get("/get-revenue-per-month", authMiddleware, OrderController.getRevenuePerMonth);
